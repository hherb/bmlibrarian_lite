...
public enum ResponseParser {
    ...
    public struct ScoreResult: Sendable, Equatable {
        ...
        /// Initialize a score result.
        public init(score: Int?, explanation: String, parseFailed: Bool) {
            self.score = score
        ...
        public static func success(score: Int, explanation: String) -> ScoreResult {
            ScoreResult(score: score, explanation: explanation, parseFailed: false)
        }

        /// Convenience for failed parses.
        public static func failure(_ message: String) -> ScoreResult {
    ...
    public static func parseScoreResponse(_ response: String) -> ScoreResult {
    ...
    public struct ParsedPassage: Sendable, Equatable {
        /// The text of the passage.
        public let text: String
        /// The relevance explanation.
        public let relevance: String

        /// Initialize a parsed passage.
    ...
    public static func parsePassagesResponse(_ response: String) -> [ParsedPassage] {
        let jsonString = extractJSON(from: response)
    ...
    public struct ParsedReport: Sendable, Equatable {
        ...
        /// Initialize a parsed report.
        public init(verdict: Verdict, summary: String, fullReport: String) {
    ...
    public static func parseReportResponse(_ response: String) -> ParsedReport {
        let jsonString = extractJSON(from: response)
    ...
    public static func parseVerdict(_ string: String) -> Verdict {
    ...
    public static func parseStringArray(_ response: String) -> [String] {
    ...
    public static func parseStructuredQueryArray(_ response: String) -> [StructuredQuery] {
        let trimmed = response.trimmingCharacters(in: .whitespacesAndNewlines)
