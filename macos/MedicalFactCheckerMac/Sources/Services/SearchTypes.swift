...
//  MedicalFactChecker
//
//  Unified types for cross-provider search functionality.
//  Provides abstractions for article metadata and pagination state
//  that work across PubMed, Europe PMC, and future providers.
//
