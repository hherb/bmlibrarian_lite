...
enum BudgetChecker {
    ...
    struct Limits {
        ...
        init(perRun: Double, monthly: Double) {
            self.perRun = perRun
    ...
    struct Usage {
        ...
        init(currentRun: Double, monthlyTotal: Double) {
    ...
    static func validate(usage: Usage, limits: Limits) throws {
    ...
    static func hasMonthlyBudget(used: Double, limit: Double) -> Bool {
        used < limit
    }
    ...
    static func remainingBudget(usage: Usage, limits: Limits) -> (perRun: Double, monthly: Double) {
