...
//  MedicalFactChecker
//
//  Toolbar items and components for search provider selection on macOS.
//  Provides UI for selecting between PubMed, Europe PMC, or both providers,
//  and toggling preprint inclusion.
//
